...
## results/ablation_bf16_keyset_pooled
precision=bf16 mean_source=pooled_controls rows=7920 neurons=11 (candidates=6) exact-zero shifts=0.002 on-1/256-grid=0.000

- FDR(0.01) survivors among 18 candidate cells: uncertain-shift 2, control-shift 0, uncertain-vs-control interaction 1, activation-slope 2, held-out-only 0
- uncorrected p<.01: uncertain 3, interaction 2, slope 4
- random control NEURONS: mean|shift| 0.01089 vs candidates 0.01131; |interaction| 0.00202 vs 0.00292
...
L31_N11541     lack_of_knowledge -0.016674  -0.003242    -0.013432       0.000200 -0.565619 -0.008100 2.949727e-11
 L31_N6772     lack_of_knowledge -0.003994   0.000369    -0.004363       0.005499 -0.309991  0.056262 1.095494e-03
 L31_N2477     lack_of_knowledge -0.002736   0.002408    -0.005143       0.128487 -0.100779 -0.010187 2.652960e-09
 L20_N5595             ambiguity -0.000745   0.004859    -0.005604       0.134387 -0.028565 -0.005136 7.757215e-01
 L31_N2477 contradictory_context -0.000201  -0.003829     0.003628       0.170483 -0.011530 -0.000411 6.712073e-01

## Frozen-RMSNorm decomposition
- L31_N2477/ambiguity: full +0.01544 (p=5e-05), frozen-norm +0.00096 (p=0.7) -> norm-mediated fraction 0.94
- L31_N2477/ambiguity (controls): full +0.01419 (p=5e-05), frozen-norm +0.00616 (p=0.0007) -> norm-mediated fraction 0.57
- L31_N2477/contradictory_context: full +0.00707 (p=0.0062), frozen-norm -0.00491 (p=0.0306) -> norm-mediated fraction 1.69
- L31_N2477/contradictory_context (controls): full +0.00324 (p=0.259), frozen-norm -0.00718 (p=0.0141) -> norm-mediated fraction 3.22
- L31_N2477/lack_of_knowledge: full +0.01434 (p=5e-05), frozen-norm -0.00129 (p=0.498) -> norm-mediated fraction 1.09
- L31_N2477/lack_of_knowledge (controls): full +0.01016 (p=5e-05), frozen-norm +0.00114 (p=0.633) -> norm-mediated fraction 0.89
